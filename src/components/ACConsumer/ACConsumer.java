...
public class ACConsumer extends Component {
	
	static ACConsumerState defaultState = new ACConsumerState(ACConsumerStates.NOMINAL);

	public ACConsumer(String name, int inputPortsSize, int outputPortsSize) {
		super(name, ComponentType.PIPE, inputPortsSize, outputPortsSize);
		this.state = defaultState;
	}
	
	public ACConsumer(String name, int inputPortsSize, int outputPortsSize, ACConsumerStates state) {
		super(name, ComponentType.PIPE, inputPortsSize, outputPortsSize);
		this.state = new ACConsumerState(state);
	}
