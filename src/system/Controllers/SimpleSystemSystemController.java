...
public class SimpleSystemSystemController {
	...
	public SimpleSystemSystemController() {
	...
	public void initialize() {
		...
		Platform.runLater(new Runnable() {
			public void run() {
				...
				drawLineBetween2Label(mainPane, valve, pipe1);
				drawLineBetween2Label(mainPane, valve, pipe2);
			}
		});
