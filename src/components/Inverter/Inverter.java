...
public class Inverter extends Component {
	...
	static InverterState defaultState = new InverterState(InverterStates.NOMINAL);

	public Inverter(String name, int inputPortsSize, int outputPortsSize) {
		super(name, ComponentType.PIPE, inputPortsSize, outputPortsSize);
		this.state = defaultState;
	}
	
	public Inverter(String name, int inputPortsSize, int outputPortsSize, InverterStates state) {
		super(name, ComponentType.PIPE, inputPortsSize, outputPortsSize);
		this.state = new InverterState(state);
	}
