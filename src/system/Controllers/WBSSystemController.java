...
public class WBSSystemController {
	...
	public void initialize() {
		...
		Platform.runLater(new Runnable() {
			public void run() {
				...
				drawLineBetween2Label(mainPane, pipeG1, selectorValve);
				drawLineBetween2Label(mainPane, pipeB1, selectorValve);
				drawLineBetween2Label(mainPane, selectorValve, pipeG2);
				drawLineBetween2Label(mainPane, selectorValve, pipeB2);
				drawLineBetween2Label(mainPane, pipeB2, accumulatorPump);
				drawLineBetween2Label(mainPane, pipeB2, mvb);
				drawLineBetween2Label(mainPane, pipeG2, mvg);
				drawLineBetween2Label(mainPane, mvb, pipeB3);
				drawLineBetween2Label(mainPane, mvg, pipeG3);
			}
		});
