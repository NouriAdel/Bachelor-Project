...
public class ExampleRCAS1Sensor extends ExampleSystem {
	...
	static Component cylinder  = new Cylinder("Cylinder", 1, 1);
	
	static Component ACE  = new ActuatorControlElectronics("ACE", 4, 1);
	...
	static Component [] systemComponents = {
			...
			ACE, ACEpower, PFC, PFCpower, ADIRU, ADIRUpower, DEL, sensor
	};
	...
	public void start(Stage stage) throws IOException {
		...
		ACE.inputPorts[3]  = sensor;
		sensor.outputPorts[0] = ACE;
